...
symbols_: {
  ...
  "include_macro_code": 149,
  "init": 128,
  "lex": 127,
  "module_code_chunk": 184,
  "name_expansion": 161,
  "name_list": 153,
  "names_exclusive": 140,
  "names_inclusive": 138,
  ...
  "option": 179,
  "option_list": 177,
  "optional_module_code_chunk": 181,
  "options": 142,
  "range_regex": 162,
  "regex": 136,
  "regex_base": 158,
  ...
  "start_conditions": 146,
  "string": 164,
  "unbracketed_action_body": 148,
  "{": 123,
  "|": 124,
  "}": 125
},
...
case 39:
    /*! Production::    nonempty_regex_list : regex_list '|' regex_concat */
    this.$ = $$[$0 - 2] + '|' + $$[$0];
    break;
...
case 41:
    /*! Production::    nonempty_regex_list : BUGGER '|' nonempty_regex_list */
    this.$ = '|' + $$[$0 - 1];
    break;

case 42:
    /*! Production::    nonempty_regex_list : BUGGER '|' */
    this.$ = '|';
    break;
...
/*! Conditions:: options */ 
/*! Rule::       "(\\\\|\\"|[^"])*" */ 
 yy_.yytext = yy_.yytext.substr(1, yy_.yytext.length - 2); return 180; 
break;
case 21 : 
/*! Conditions:: options */ 
/*! Rule::       '(\\\\|\\'|[^'])*' */ 
...
/*! Conditions:: indented */ 
/*! Rule::       %\{(.|{BR})*?%\} */ 
 this.begin('trail'); yy_.yytext = yy_.yytext.substr(2, yy_.yytext.length - 4); return 150; 
break;
case 31 : 
/*! Conditions:: indented trail rules macro INITIAL */ 
/*! Rule::       %\{(.|{BR})*?%\} */ 
 yy_.yytext = yy_.yytext.substr(2, yy_.yytext.length - 4); return 150; 
break;
case 32 : 
/*! Conditions:: indented */ 
/*! Rule::       %include\b */ 
...
/*! Conditions:: indented trail rules macro INITIAL */ 
/*! Rule::       "(\\\\|\\"|[^"])*" */ 
 yy_.yytext = yy_.yytext.replace(/\\"/g,'"'); return 174; 
break;
case 42 : 
/*! Conditions:: indented trail rules macro INITIAL */ 
/*! Rule::       '(\\\\|\\'|[^'])*' */ 
...
/*! Rule::       %include\b */ 
 this.pushState('path'); return 182; 
break;
case 67 : 
...
/*! Conditions:: set */ 
/*! Rule::       \] */ 
 this.popState('set'); return 169; 
break;
case 80 : 
/*! Conditions:: code */ 
/*! Rule::       [^\r\n]+ */ 
 return 185;      // the bit of CODE just before EOF... 
break;
case 81 : 
/*! Conditions:: path */ 
/*! Rule::       {BR} */ 
...
/*! Conditions:: path */ 
/*! Rule::       '[^\r\n]+' */ 
 yy_.yytext = yy_.yytext.substr(1, yy_.yyleng - 2); this.popState(); return 183; 
break;
case 83 : 
/*! Conditions:: path */ 
/*! Rule::       "[^\r\n]+" */ 
