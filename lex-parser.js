...
symbols_: {
  ...
  "names_exclusive": 32,
  "names_inclusive": 30,
  "nonempty_regex_list": 48,
  "option": 72,
  "option_list": 70,
  "optional_module_code_chunk": 74,
  "options": 36,
  "range_regex": 55,
  "regex": 28,
  "regex_base": 51,
...
case 21:
    ...
    this.$ = yyvstack[$0 - 1].concat(yyvstack[$0]);
    break;

case 23:
    /*! Production::    rules_collective : start_conditions rule */
    if (yyvstack[$0 - 1]) {
        yyvstack[$0].unshift(yyvstack[$0 - 1]);
    }
    this.$ = [yyvstack[$0]];
    break;
...
case 24:
    ...
    if (yyvstack[$0 - 3]) {
        yyvstack[$0 - 1].forEach(function (d) {
            d.unshift(yyvstack[$0 - 3]);
        });
    }
    this.$ = yyvstack[$0 - 1];
    break;
...
case 25:
    ...
    this.$ = $rules; this.$.push(yyvstack[$0]);
    break;
...
/*! Conditions:: options */ 
/*! Rule::       "(\\\\|\\"|[^"])*" */ 
 yy_.yytext = yy_.yytext.substr(1, yy_.yytext.length - 2); return 73; 
break;
case 21 : 
/*! Conditions:: options */ 
/*! Rule::       '(\\\\|\\'|[^'])*' */ 
...
/*! Conditions:: indented trail rules macro INITIAL */ 
/*! Rule::       "(\\\\|\\"|[^"])*" */ 
 yy_.yytext = yy_.yytext.replace(/\\"/g,'"'); return 67; 
break;
case 42 : 
/*! Conditions:: indented trail rules macro INITIAL */ 
/*! Rule::       '(\\\\|\\'|[^'])*' */ 
...
/*! Conditions:: set */ 
/*! Rule::       \] */ 
 this.popState('set'); return 62; 
break;
case 80 : 
/*! Conditions:: code */ 
/*! Rule::       [^\r\n]+ */ 
 return 78;      // the bit of CODE just before EOF... 
break;
case 81 : 
/*! Conditions:: path */ 
/*! Rule::       {BR} */ 
...
/*! Conditions:: path */ 
/*! Rule::       '[^\r\n]+' */ 
 yy_.yytext = yy_.yytext.substr(1, yy_.yyleng - 2); this.popState(); return 76; 
break;
case 83 : 
/*! Conditions:: path */ 
/*! Rule::       "[^\r\n]+" */ 
