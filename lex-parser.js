...
/* parser generated by jison 0.6.0-187.2 */
...
case 2:
    ...
    yyparser.yyError("Maybe you did not correctly separate the lexer sections with a '%%' on an otherwise empty line? The lexer spec file should have this structure:\n  definitions  %%  rules  [%%  extra_module_code]\n\nErroneous code:\n" + prettyPrintRange(yylexer, yylstack[yysp - 1]));
    break;
...
case 13:
    ...
    yyparser.yyError("Seems you did not correctly bracket the lexer preparatory action block in curly braces: '{ ... }'.\n\n  Offending action body:\n" + prettyPrintRange(yylexer, yylstack[yysp], yylstack[yysp - 1]));
    break;
...
case 26:
    ...
    yyparser.yyError("Seems you made a mistake while specifying one of the lexer rules inside the start condition <" + yyvstack[yysp - 3].join(',') + "> { rules... } block.\n\n  Erroneous area:\n" + prettyPrintRange(yylexer, yylexer.mergeLocationInfo((yysp - 3), (yysp)), yylstack[yysp - 3]));
    break;

case 27:
    /*! Production::    rules_collective : start_conditions "{" error */
    yyparser.yyError("Seems you did not correctly bracket a lexer rules set inside the start condition <" + yyvstack[yysp - 2].join(',') + "> { rules... } as a terminating curly brace '}' could not be found.\n\n  Erroneous area:\n" + prettyPrintRange(yylexer, yylstack[yysp], yylstack[yysp - 2]));
    break;
...
case 33:
    ...
    yyparser.yyError("Seems you did not correctly bracket a lexer rule action block in curly braces: '{ ... }'.\n\n  Offending action body:\n" + prettyPrintRange(yylexer, yylstack[yysp], yylstack[yysp - 2]));
    break;
...
/* lexer generated by jison-lex 0.6.0-186 */
    ...
    */
    ...
    performAction: function lexer__performAction(yy, yy_, yyrulenumber, YY_START) {
      ...
      case 31:
        ...
        /*  this.unput(yy_.yytext); can be used here instead of this.reject(); which would only work when we set the backtrack_lexer option */
        break;
      case 32:
        /*! Conditions:: indented */
        /*! Rule::       {WS}*{BR}+ */
    ...
    rules: [
      ...
      /* 26: */  /^(?:(\r\n|\n|\r))/,
      /* 27: */  /^(?:([^\S\n\r])+)/,
      /* 28: */  new XRegExp('^(?:([\\p{Alphabetic}_](?:[\\p{Alphabetic}\\p{Number}_])*))', ''),
      /* 29: */  /^(?:(\r\n|\n|\r)+)/,
      /* 30: */  /^(?:([^\S\n\r])+)/,
      /* 31: */  /^(?:([^\S\n\r])*(\r\n|\n|\r)+)/,
      /* 32: */  /^(?:([^\S\n\r])*(\r\n|\n|\r)+)/,
      ...
      /* 59: */  /^(?:\/!)/,
      /* 60: */  /^(?:\/)/,
      /* 61: */  /^(?:\\([0-7]{1,3}|[$(-+.\/?BDSW\[-\^bdfnr-tvw{-}]|c[A-Z]|x[\dA-F]{2}|u[\dA-Fa-f]{4}))/,
      /* 62: */  /^(?:\\.)/,
      /* 63: */  /^(?:\$)/,
      /* 64: */  /^(?:\.)/,
      /* 65: */  /^(?:%options\b)/,
