...
symbols_: {
  ...
  "ACTION": 29,
  "ACTION_BODY": 30,
  "ACTION_BODY_CPP_COMMENT": 32,
  "ACTION_BODY_C_COMMENT": 31,
  "ACTION_BODY_WHITESPACE": 33,
  "ACTION_END": 28,
  "ACTION_START": 25,
  "BRACKET_MISSING": 26,
  "BRACKET_SURPLUS": 27,
  ...
  "ESCAPE_CHAR": 41,
  "INCLUDE": 49,
  "INCLUDE_PLACEMENT_ERROR": 34,
  "NAME": 20,
  "NAME_BRACE": 37,
  "OPTIONS": 45,
  "OPTIONS_END": 46,
  "OPTION_STRING_VALUE": 47,
  "OPTION_VALUE": 48,
  "PATH": 50,
  "RANGE_REGEX": 42,
  "REGEX_SET": 40,
...
terminals_: {
  ...
  29: "ACTION",
  30: "ACTION_BODY",
  31: "ACTION_BODY_C_COMMENT",
  32: "ACTION_BODY_CPP_COMMENT",
  33: "ACTION_BODY_WHITESPACE",
  34: "INCLUDE_PLACEMENT_ERROR",
  35: "SPECIAL_GROUP",
  36: "/!",
  37: "NAME_BRACE",
  38: "REGEX_SET_START",
...
performAction: function parser__PerformAction(yytext, yyloc, yystate /* action[1] */, yysp, yyrulelength, yyvstack, yylstack, yystack, yysstack) {
...
case 2:
    ...
    The lexer spec file should have this structure:
      ...
      Erroneous code:
    ` + prettyPrintRange(yylexer, yylstack[yysp - 1]));
    break;
...
case 23:
    ...
    block.
      ...
      Erroneous area:
    ` + prettyPrintRange(yylexer, yylexer.mergeLocationInfo((yysp - 3), (yysp)), yylstack[yysp - 3]));
    break;
...
case 24:
    ...
    as a terminating curly brace '}' could not be found.
      ...
      Erroneous area:
    ` + prettyPrintRange(yylexer, yylstack[yysp], yylstack[yysp - 2]));
    break;
...
case 28:
    ...
    yyparser.yyError("lexer rule regex action code declaration error?\n\n  Erroneous area:\n" + prettyPrintRange(yylexer, yylstack[yysp], yylstack[yysp - 1]));
    break;
...
case 42:
    ...
    yyparser.yyError("Seems you did not correctly terminate the start condition set <" + yyvstack[yysp - 1].join(',') + ",???> with a terminating '>'\n\n  Erroneous area:\n" + prettyPrintRange(yylexer, yylstack[yysp], yylstack[yysp - 2]));
    break;
...
case 129:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
                // error recovery reduction action (action generated by jison, 
                // using the user-specified `%code error_recovery_reduction` %{...%}
                // code chunk below.

                
                var yye_values = yyvstack.slice(yysp - yyrulelength, yysp + 1);
                var yye_symbols = yystack.slice(yysp - yyrulelength, yysp + 1);
                $$ = {
                    values: yye_values,
                    symbols: yye_symbols
                };
        ...
        for (;;) {
            ...
            if (this.defaultActions[state]) {
                ...
                if (!action) {
                    ...
                    console.log('########## performAction: COMBINE', {
                        sp,
                        vstack,
                        stack,
                        sstack,
                    ...
                    r = this.performAction.call(yyval, yytext, yyloc, NO_ACTION[1], sp - 1, len, vstack, lstack, stack, sstack);
            ...
            case 2:
                ...
                r = this.performAction.call(yyval, yytext, yyloc, newState, sp - 1, len, vstack, lstack, stack, sstack);
...
var lexer = function() {
    ...
    */
    ...
    performAction: function lexer__performAction(yy, yy_, yyrulenumber, YY_START) {
        ...
        if (yy.depth <= 0) {
          yy_.yyerror(rmCommonWS`
                                                    ...
                                                    to help jison grok more or less complex action code chunks.
                                                      ...
                                                      Erroneous area:
                                                    ` + prettyPrintRange(this, yy_.yylloc));
      ...
      case 17:
        ...
        return 33;           // keep empty lines as-is inside action code blocks. 
        break;
      case 18:
        /*! Conditions:: action */
        /*! Rule::       {BR} */
      ...
      case 35:
        ...
        return 47;   // value is always a string type 
        break;
      case 36:
        /*! Conditions:: options */
        /*! Rule::       '{QUOTED_STRING_CONTENT}' */
      ...
      case 88:
        /*! Conditions:: code */
        /*! Rule::       [^\r\n]+ */
        return 51;      // the bit of CODE just before EOF... 
    ...
    rules: [
      ...
      /*  66: */  /^(?:\/!)/,
      /*  67: */  /^(?:\/)/,
      /*  68: */  /^(?:\\([0-7]{1,3}|[$(-+.\/?BDSW\[-\^bdfnr-tvw{-}]|c[A-Z]|x[\dA-F]{2}|u[\dA-Fa-f]{4}))/,
      /*  69: */  /^(?:\\.)/,
      /*  70: */  /^(?:\$)/,
      /*  71: */  /^(?:\.)/,
      /*  72: */  /^(?:%options\b)/,
      ...
      /*  78: */  /^(?:%%)/,
      /*  79: */  /^(?:\{\d+(,\s*\d+|,)?\})/,
      /*  80: */  new XRegExp('^(?:\\{([\\p{Alphabetic}_](?:[\\p{Alphabetic}\\p{Number}_])*)\\})', ''),
    ...
    conditions: {
      ...
      'code': {
        rules: [76, 77, 87, 88, 100, 101, 102, 104, 105],
        inclusive: false
      },

      'start_condition': {
        rules: [24, 25, 42, 43, 44, 100, 101, 102, 104, 105],
        inclusive: false
      },
      ...
      'conditions': {
        rules: [20, 21, 22, 23, 100, 101, 102, 104, 105],
        inclusive: false
      },
      ...
      'path': {
        rules: [24, 25, 89, 90, 91, 92, 93, 100, 101, 102, 104, 105],
        inclusive: false
      },

      'set': {
        rules: [81, 84, 85, 86, 100, 101, 102, 104, 105],
        inclusive: false
      },
  ...
  function prettyPrintRange(lexer, loc, context_loc, context_loc2) {
    ...
    var l0 = Math.max(
      1,
      (!show_context ? loc.first_line : (context_loc ? context_loc.first_line : loc.first_line - CONTEXT))
    );

    var l1 = Math.max(
      1,
      (!show_context ? loc.last_line : (context_loc2 ? context_loc2.last_line : loc.last_line + CONTEXT_TAIL))
    );
