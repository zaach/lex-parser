...
/* parser generated by jison 0.6.0-190 */
...
case 2:
    ...
    //console.log("error reduction action: ", yyparser.yyGetErrorInfoTrack());
    
    if (0) {    
        console.log("@error dump:", {
          yysp,
          errtoc:  /* error */ 2,
          errloc: yylstack[yysp - 1],
          error: yyvstack[yysp - 1],
        });
    }
        ...
        for (;;) {
            ...
            if (this.defaultActions[state]) {
                ...
                if (!action) {
                    ...
                    r = this.performAction.call(yyval, yytext, yyloc, NO_ACTION[1], sp - 1, yyrulelen, vstack, lstack, stack, sstack);
                    ...
                    while (symbol) {
                        ...
                        case 2:
                            ...
                            r = this.performAction.call(yyval, yytext, yyloc, newState, sp - 1, yyrulelen, vstack, lstack, stack, sstack);
...
/* lexer generated by jison-lex 0.6.0-190 */
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      switch (yyrulenumber) {
        ...
        case 77:
          ...
          this.warn(
            rmCommonWS`
                                                LEX: ignoring unsupported lexer option ${dquote(
                                                  yy_.yytext
                                                )}
        ...
        case 104:
          ...
          yy_.yyerror(
            rmCommonWS`
                                                unsupported lexer input: ${dquote(
                                                  yy_.yytext
                                                )} 
